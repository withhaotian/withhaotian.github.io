...
My research primarily focuses on *Edge Intelligence*, with particular emphasis on distributed edge inference, serverless edge computing, and resource management in cloud-edge computing systems:

- Distributed Edge Inference: Developing distributed edge inference algorithms or systems, including how to deploy and configure AI models on edge devices/servers, and optimize the inference performance in cloud-edge computing.
- Serverless Edge Computing: Optimizing the workload scheduling and resource management for Function as a Service (FaaS) applications, especially for AI/ML workloads, in cloud-edge computing systems.
